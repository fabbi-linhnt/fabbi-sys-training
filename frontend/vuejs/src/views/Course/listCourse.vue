  ...
  <div class="card shadow">
    ...
    <b-table show-empty small stacked="md" :items="courses" :fields="fields">
      ...
      <template v-slot:cell(actions)="row">
        <b-icon
          v-b-tooltip.hover.top="$t('course_screen.label.delete')"
          icon="trash"
          variant="danger"
          font-scale="2"
        ...
        <b-icon
          v-b-tooltip.hover.top="$t('course_screen.label.detail')"
          icon="info-circle"
          variant="info"
          font-scale="2"
          @click="
        ...
        <b-icon
          v-b-tooltip.hover.top="$t('course_screen.label.update')"
          icon="pencil-square"
          variant="dark"
          font-scale="2"
          @click="
